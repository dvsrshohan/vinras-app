        ...
        <div className="container lg:w-[90%]">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-14 my-16 items-center">
            <div className="z-[-1]">
              ...
              <h2 className='xl:text-[50px] text-[33px] font-bold'>Creating Value Through Business</h2>
              <p>
            ...
            <div className="">
              <div style={{ zIndex: '999999' }} className="bg-white rounded-[20px] w-auto shadow-lg lg:p-12 p-6 text-center lg:w-[75%] mx-auto lg:mt-[-200px]">
