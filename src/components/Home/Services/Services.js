...
const Services = () => {
  return (
    <div className='bg-[url(https://i.ibb.co/yV0xxLg/BG1.png)] bg-cover bg-center bg-no-repeat lg:bg-[100%_100%]'>
      <div className="container py-24">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[26px] my-[60px]">
          <div className="bg-white shadow">
            <div className="flex items-end justify-between mr-[35px]">
              <div className="bg-primary py-3 pr-[22px] pl-[29px] rounded-tr rounded-br">
                <p className='text-white text-[16px] font-semibold'>Business</p>
              </div>
              <div className="bg-primary py-[18px] px-5 rounded">
                <img src="/images/services-icon.png" alt="" srcset="" />
              </div>
            </div>
