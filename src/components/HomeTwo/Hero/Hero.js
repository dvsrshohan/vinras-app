      ...
      <div className="h-[100vh] flex items-end" style={{
        ...
        <div className="container my-auto">
          <div className="grid xl:grid-cols-2 grid-cols-1">
            <div className="">
              <div className="md:text-[30px] text-[22px] font-medium text-white">
                <span>Technology </span> <span>|</span> <span> Business  </span> <span> | </span> <span>Consultan</span>
              </div>
              <h2 className='2xl:text-[90px] md:text-[60px] text-[36px] font-bold text-white '>Best Grow Your Business</h2>
              <p className="md:text-[30px] text-[22px] font-semibold text-white">Our  Best Business Technology Consulting</p>
